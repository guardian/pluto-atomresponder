GROUP_GNM_ASSET = "Asset"
GNM_ASSET_CATEGORY = 'gnm_category'
GNM_ASSET_KEYWORDS = 'gnm_keywords'
GNM_ASSET_ORIGINAL_FILENAME = 'original_filename'
GNM_ASSET_OWNER = 'gnm_owner'
GNM_ASSET_MEDIA_FLAGS = 'gnm_media_flags'
GNM_ASSET_CONTAINING_PROJECTS = 'gnm_containing_projects'
GNM_ASSET_FILE_CREATED = 'gnm_file_created'
