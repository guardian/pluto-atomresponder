## Commented out as these functions will all be re-written. Kept for reference.
# import django.test
...
#         :return:
#         """
#         from atomresponder.signals import edl_import_success
...
#         :return:
#         """
#         from atomresponder.signals import edl_import_failure
#         from atomresponder.models import PacFormXml
#         from celery import Task
#         import traceback
#
...
#         :return:
#         """
#         from atomresponder.signals import edl_import_revoked
#         from atomresponder.models import PacFormXml
#         from celery import Task
#
#         mock_sender = MagicMock(target=Task)
